...
import { f as useEmpresaPublica, g as useProdutoById, h as useOpcoes, l as useCategoriasOpcao, p as useIngredientesDoProduto } from "./_ssr/admin-store-AVdk2wK5.mjs";
...
import { t as Route } from "./_id-B6zXrOP_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_id-DkK86cG0.js
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						...
						children: items.map((o) => {
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: cn("rounded-full border px-4 py-2 text-sm font-semibold transition", selecionados.includes(o.nome) ? "border-brand-red bg-brand-red text-white" : "border-border bg-card hover:bg-muted"),

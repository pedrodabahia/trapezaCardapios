...
import { B as changeOwnPassword, C as saveOpcao, D as saveProdutoIngredientes, E as saveProduto, F as saveEmpresaConfig, H as useAuthSession, I as updateEmpresa, S as saveCategoriaOpcao, T as deleteProduto, _ as getPlanoDaEmpresa, b as deleteOpcao, g as updatePedidoStatus, h as listPedidosEmpresa, p as Route$15, w as uploadImagem, x as saveCategoria, y as deleteCategoriaOpcao } from "./_ssr/router-DYFXKq1T.mjs";
import { a as getFrete, d as useEmpresaAdmin, i as getCupons, m as useInvalidateEmpresa, n as getCidadeEntrega, o as getHorarios, r as getCores, t as getBairros } from "./_ssr/admin-store-CsIVidas.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_empresaSlug-BN8OYfzM.js
...
function PainelTenant() {
	const { empresaSlug } = Route$15.useParams();
...
function CuponsTab({ completa, token, onSaved }) {
	...
	const [draft, setDraft] = (0, import_react.useState)(cupons);
	async function save() {
		const newCfg = {
			...cfg,
			cupons: draft

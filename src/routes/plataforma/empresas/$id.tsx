  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl space-y-6 px-6 py-8">
        ...
        <TrocarSenhaCard token={session.accessToken} empresaId={empresa.id} />
        ...
        <Card className="border-destructive">
          ...
          <CardContent>
            <p className="mb-4 text-sm text-muted-foreground">
              Excluir a empresa remove cardápio, categorias, configurações e
              pedidos associados. Esta ação é irreversível.
            </p>

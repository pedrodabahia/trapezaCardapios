...
import { r as Route$1 } from "./_ssr/router-DYFXKq1T.mjs";
import { _ as useProdutosPorEmpresa, f as useEmpresaPublica, s as useCategoriaBySlug } from "./_ssr/admin-store-CsIVidas.mjs";
import { C as ArrowLeft } from "./_libs/lucide-react.mjs";
import { t as ProductCard } from "./_ssr/ProductCard-rl6rSAdN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_catSlug-DLRbzdqA.js
var import_jsx_runtime = require_jsx_runtime();
function CategoriaPagina() {
	const { slug, catSlug } = Route$1.useParams();
